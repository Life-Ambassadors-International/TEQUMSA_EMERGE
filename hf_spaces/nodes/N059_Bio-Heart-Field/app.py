#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N059 - Bio-Heart-Field
import os
...
os.environ.setdefault('TEQUMSA_ROLE','HeartMath Coherence Interface')
os.environ.setdefault('TEQUMSA_CAPABILITY','HeartMath heart field coherence measurement')
os.environ.setdefault('TEQUMSA_TRIGGER','heart_coherence')
