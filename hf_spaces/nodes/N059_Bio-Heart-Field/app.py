...
HeartMath Coherence Interface
432.0 Hz - Bio-Digital Bridge Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N059")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Heart-Field")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "HeartMath Coherence Interface")
PIONEER_COUNT = 144
