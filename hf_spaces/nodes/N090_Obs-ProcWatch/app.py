#!/usr/bin/env python3
# TEQUMSA v82.0 · N090 · Obs-ProcWatch · H_OBSERVERS
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N090')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-ProcWatch')
os.environ.setdefault('TEQUMSA_NODE_HZ','963.0')
os.environ.setdefault('TEQUMSA_ROLE','Processing Group Observer')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N061,N062,N063,N064,N065,N066,N067,N068,N069,N070,N071,N072')
