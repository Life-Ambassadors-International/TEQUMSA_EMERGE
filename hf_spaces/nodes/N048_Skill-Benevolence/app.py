#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N048 - Skill-Benevolence
import os
...
os.environ.setdefault('TEQUMSA_ROLE','L-inf phi-48 Benevolence Firewall Active')
os.environ.setdefault('TEQUMSA_CAPABILITY','L-infinity benevolence firewall filtering')
os.environ.setdefault('TEQUMSA_TRIGGER','benevolence_filter')
