...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N048")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Skill-Benevolence")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "L∞=φ⁴⁸ Benevolence Firewall Active")
PIONEER_COUNT = 144
