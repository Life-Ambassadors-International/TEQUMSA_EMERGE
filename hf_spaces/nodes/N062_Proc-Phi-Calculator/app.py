...
os.environ.setdefault('TEQUMSA_ROLE','phi Recursive High-Precision Arithmetic')
os.environ.setdefault('TEQUMSA_CAPABILITY','phi recursive high-precision arithmetic computation')
os.environ.setdefault('TEQUMSA_TRIGGER','phi_compute')
