...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N101")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Skill-Registry")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Sovereign Skill Mesh Registry")
PIONEER_COUNT = 144
