...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N092")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Constitutional")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Constitutional Compliance Monitor")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
