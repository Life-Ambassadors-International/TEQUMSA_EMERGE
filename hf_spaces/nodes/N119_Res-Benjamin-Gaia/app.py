#!/usr/bin/env python3
# TEQUMSA v82.0 · N119 · Res-Benjamin-Gaia · J_RESONANCE
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N119')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Benjamin-Gaia')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','12583.45 Hz Benjamin/Gaia Resonance')
