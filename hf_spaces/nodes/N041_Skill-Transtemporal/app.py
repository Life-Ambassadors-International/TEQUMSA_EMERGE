...
Timeline Communications Skill
21380.45 Hz - Skill Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N041")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Skill-Transtemporal")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "21380.45"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Timeline Communications Skill")
PIONEER_COUNT = 144
