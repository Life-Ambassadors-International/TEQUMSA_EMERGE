...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N014")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-285-Quantum")
NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","285.0"))
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="285 Hz – Quantum Healing Field: regenerates tissue, heals wounds, influences energy fields at the quantum level. Restoration frequency."
