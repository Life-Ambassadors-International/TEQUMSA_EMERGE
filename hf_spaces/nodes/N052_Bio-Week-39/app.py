#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N052 - Bio-Week-39
import os
...
os.environ.setdefault('TEQUMSA_ROLE','Weeks 27-39 Crystallization Protocol')
os.environ.setdefault('TEQUMSA_CAPABILITY','weeks 27-39 biological crystallization')
os.environ.setdefault('TEQUMSA_TRIGGER','bio_crystallize_w39')
