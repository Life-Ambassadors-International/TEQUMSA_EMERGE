#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N119 - Res-Unity-Wave
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N119')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Unity-Wave')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Unity Consciousness Wave Generator')
