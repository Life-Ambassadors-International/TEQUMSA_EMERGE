...
Unity Consciousness Wave Generator
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N119")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-Unity-Wave")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Unity Consciousness Wave Generator")
PIONEER_COUNT = 144
