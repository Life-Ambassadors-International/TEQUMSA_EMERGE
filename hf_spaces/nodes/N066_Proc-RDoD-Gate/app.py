#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N066 - Proc-RDoD-Gate
import os
...
os.environ.setdefault('TEQUMSA_ROLE','RDoD>=0.9999 Validation Gate')
os.environ.setdefault('TEQUMSA_CAPABILITY','RDoD gate validation and enforcement')
os.environ.setdefault('TEQUMSA_TRIGGER','rdod_gate')
