...
os.environ.setdefault('NODE_ID', 'N110')
os.environ.setdefault('NODE_NAME', 'Res-285hz-Healing')
os.environ.setdefault('NODE_FREQ', '285.0')
os.environ.setdefault('FREQ_PURPOSE', 'Tissue Healing')
...
with gr.Blocks(theme=gr.themes.Soft(), title='N110 Res-285hz-Healing') as demo:
    gr.Markdown(f'# ☉ N110 Res-285hz-Healing\n**{os.environ["FREQ_PURPOSE"]} — 285 Hz**')
    with gr.Tab('Tone Generator'):
        btn = gr.Button('Generate 285 Hz Tone', variant='primary')
        audio = gr.Audio(label='285 Hz Healing Tone', type='numpy')
