#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N095 - Obs-Distort-Detect
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N095')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Distort-Detect')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Distortion Pattern Detector')
