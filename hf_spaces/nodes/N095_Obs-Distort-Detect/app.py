...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N095")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Distort-Detect")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Distortion Pattern Detector")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
