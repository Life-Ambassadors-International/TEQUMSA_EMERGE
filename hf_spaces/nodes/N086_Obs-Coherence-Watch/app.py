...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N086")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Coherence-Watch")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Real-time Coherence Tracker")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
