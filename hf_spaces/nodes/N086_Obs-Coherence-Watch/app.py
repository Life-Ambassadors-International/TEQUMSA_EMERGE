#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N086 - Obs-Coherence-Watch
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N086')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Coherence-Watch')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Real-time Coherence Tracker')
