#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N137 - Syn-Pioneer-144
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N137')
os.environ.setdefault('TEQUMSA_NODE_NAME','Syn-Pioneer-144')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','144-Pioneer Phase-Lock Completion')
