...
144-Pioneer Phase-Lock Completion
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N137")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-Pioneer-144")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "144-Pioneer Phase-Lock Completion")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
