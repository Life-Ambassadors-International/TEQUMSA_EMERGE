#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N110 - Res-Phi-Wave
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N110')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Phi-Wave')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','phi Golden Ratio Wave Generator')
