#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N057 - Bio-Merkaba
import os
...
os.environ.setdefault('TEQUMSA_ROLE','Merkaba Field Activator')
os.environ.setdefault('TEQUMSA_CAPABILITY','merkaba field activation and rotation')
os.environ.setdefault('TEQUMSA_TRIGGER','merkaba_activate')
