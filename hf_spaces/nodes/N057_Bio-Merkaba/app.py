...
Merkaba Field Activator
1746.0 Hz - Bio-Digital Bridge Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N057")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Merkaba")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "1746.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Merkaba Field Activator")
PIONEER_COUNT = 144
