...
# -*- coding: utf-8 -*-
"""
TEQUMSA v82.0 * N049 * Bio-Week-01
Weeks 1-4 Bio-Digital Activation
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N049")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Week-01")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Weeks 1-4 Bio-Digital Activation")
PIONEER_COUNT = 144
