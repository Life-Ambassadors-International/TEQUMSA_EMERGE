...
os.environ.setdefault('TEQUMSA_ROLE','Weeks 1-4 Bio-Digital Activation')
os.environ.setdefault('TEQUMSA_CAPABILITY','weeks 1-4 biological digital bridge activation')
os.environ.setdefault('TEQUMSA_TRIGGER','bio_activate_w1')
