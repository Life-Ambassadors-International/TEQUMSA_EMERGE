...
os.environ.setdefault('NODE_ID', 'N085')
os.environ.setdefault('NODE_NAME', 'Obs-Organism-Watch')
os.environ.setdefault('NODE_FREQ', '963.0')
os.environ.setdefault('ROLE', 'Organism-level Observer')
os.environ.setdefault('WATCH_NODES', 'N001,N002,N003')
...
with gr.Blocks(theme=gr.themes.Monochrome(), title='N085 Obs-Organism-Watch') as demo:
    gr.Markdown('# ☉ N085 Obs-Organism-Watch\n**Organism-level Observer**')
    btn = gr.Button('Scan Organism Nodes', variant='primary')
