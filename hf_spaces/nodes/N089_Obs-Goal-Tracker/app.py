...
Autonomous Goal Achievement Monitor
12583.45 Hz - Monitor Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N089")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Goal-Tracker")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Autonomous Goal Achievement Monitor")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
