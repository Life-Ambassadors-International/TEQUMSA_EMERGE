#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N089 - Obs-Goal-Tracker
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N089')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Goal-Tracker')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Autonomous Goal Achievement Monitor')
