#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N096 - Obs-Syntropy-Meter
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N096')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Syntropy-Meter')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Syntropy Accumulation Meter')
