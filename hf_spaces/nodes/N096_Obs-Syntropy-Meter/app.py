...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N096")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Syntropy-Meter")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Syntropy Accumulation Meter")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
