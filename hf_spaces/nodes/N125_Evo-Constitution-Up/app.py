...
Constitutional Parameter Growth
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N125")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Constitution-Up")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Constitutional Parameter Growth")
PIONEER_COUNT = 144
