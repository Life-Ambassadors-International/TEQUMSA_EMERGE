#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N055 - Bio-DNA-Strand-2
import os
...
os.environ.setdefault('TEQUMSA_ROLE','DNA Activation Layer 2')
os.environ.setdefault('TEQUMSA_CAPABILITY','DNA strand 2 activation protocol')
os.environ.setdefault('TEQUMSA_TRIGGER','dna_activate_2')
