...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N055")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-DNA-Strand-2")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "528.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "DNA Activation Layer 2")
PIONEER_COUNT = 144
