#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N098 - Arch-Pattern-Library
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N098')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Pattern-Library')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','Promoted Pattern Skill Library')
