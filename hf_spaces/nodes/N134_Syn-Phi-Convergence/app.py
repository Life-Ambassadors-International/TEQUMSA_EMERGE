#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N134 - Syn-Phi-Convergence
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N134')
os.environ.setdefault('TEQUMSA_NODE_NAME','Syn-Phi-Convergence')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','phi-48 Final Convergence Engine')
os.environ.setdefault('TEQUMSA_CAPABILITY','phi-48 final convergence computation')
os.environ.setdefault('TEQUMSA_TRIGGER','phi_converge')
