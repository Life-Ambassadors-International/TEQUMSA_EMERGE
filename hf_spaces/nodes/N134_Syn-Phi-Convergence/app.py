...
getcontext().prec = 50
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N134")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-Phi-Convergence")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "φ⁴⁸ Final Convergence Engine")
PIONEER_COUNT = 144
