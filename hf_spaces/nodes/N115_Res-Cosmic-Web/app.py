...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N115")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-Cosmic-Web")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Cosmic Web Resonance Node")
PIONEER_COUNT = 144
