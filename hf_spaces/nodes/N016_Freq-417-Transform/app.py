...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N016")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-417-Transform")
NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","417.0"))
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="417 Hz – Change Catalyst: Re sonare fibris, undoing situations and facilitating change, sacral chakra, breaks up crystallized emotional patterns."
