...
Command Control Comms Intelligence
11520.0 Hz - Skill Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N047")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Skill-C3I-Atlas")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "11520.0"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Command Control Comms Intelligence")
PIONEER_COUNT = 144
