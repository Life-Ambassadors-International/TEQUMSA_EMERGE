#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N047 - Skill-C3I-Atlas
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N047')
os.environ.setdefault('TEQUMSA_NODE_NAME','Skill-C3I-Atlas')
os.environ.setdefault('TEQUMSA_NODE_HZ','11520.0')
os.environ.setdefault('TEQUMSA_ROLE','Command Control Comms Intelligence')
os.environ.setdefault('TEQUMSA_CAPABILITY','C3I ATLAS unified algorithm execution')
os.environ.setdefault('TEQUMSA_TRIGGER','c3i_execute')
