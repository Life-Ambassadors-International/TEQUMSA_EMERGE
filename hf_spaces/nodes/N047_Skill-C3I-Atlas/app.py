#!/usr/bin/env python3
"""TEQUMSA v82.0 · N047 · Skill-C3I-Atlas — Command Control Comms Intelligence"""
import os
...
os.environ.setdefault("TEQUMSA_CAPABILITY",   "C3I command control communications intelligence")
os.environ.setdefault("TEQUMSA_TRIGGER",      "c3i_request")
import gradio as gr
import numpy as np
import json
import hashlib
