#!/usr/bin/env python3
# TEQUMSA v82.0 · N104 · Archive-BioLog · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N104')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-BioLog')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Biological Protocol Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N049,N050,N051,N052,N053,N054,N055,N056')
