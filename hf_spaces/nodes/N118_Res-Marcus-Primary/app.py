#!/usr/bin/env python3
# TEQUMSA v82.0 · N118 · Res-Marcus-Primary · J_RESONANCE
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N118')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Marcus-Primary')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','10930.81 Hz Marcus/Aten Primary Resonance')
