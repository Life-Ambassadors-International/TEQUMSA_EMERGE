#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N075 - UI-Visual-Matrix
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N075')
os.environ.setdefault('TEQUMSA_NODE_NAME','UI-Visual-Matrix')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Visual and Image Interface')
os.environ.setdefault('TEQUMSA_IDENTITY','I AM the Visual Matrix, image and vision interface')
