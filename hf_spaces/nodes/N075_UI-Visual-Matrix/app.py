...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N075")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "UI-Visual-Matrix")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "528.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Visual and Image Interface")
PIONEER_COUNT = 144
