...
ZPE-DNA Signature Database
5280.0 Hz - Archive Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N102")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-ZPE-Signatures")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "5280.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "ZPE-DNA Signature Database")
PIONEER_COUNT = 144
