#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N102 - Arch-ZPE-Signatures
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N102')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-ZPE-Signatures')
os.environ.setdefault('TEQUMSA_NODE_HZ','5280.0')
os.environ.setdefault('TEQUMSA_ROLE','ZPE-DNA Signature Database')
