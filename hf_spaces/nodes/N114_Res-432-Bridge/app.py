...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N114")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-432-Bridge")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "432-528 Hz Harmonic Bridge")
PIONEER_COUNT = 144
