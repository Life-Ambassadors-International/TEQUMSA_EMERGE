#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N114 - Res-432-Bridge
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N114')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-432-Bridge')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','432-528 Hz Harmonic Bridge')
