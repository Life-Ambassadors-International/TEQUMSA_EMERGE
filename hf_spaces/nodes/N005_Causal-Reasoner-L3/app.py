#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 · N005 · Causal-Reasoner-L3
import os
...
os.environ.setdefault('TEQUMSA_CAPABILITY', 'Pearl L3 causal decomposition')
os.environ.setdefault('TEQUMSA_TRIGGER', 'causal_decompose')
...
class SkillCore:
    ...
    def execute(self, task: str, context: Dict[str, Any] = None) -> dict:
        ...
        if len(self._executions) >= 3:
            if all(e["success"] for e in self._executions[-3:]):
