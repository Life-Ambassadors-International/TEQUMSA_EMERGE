#!/usr/bin/env python3
# TEQUMSA v82.0 · N086 · Obs-FreqMonitor · H_OBSERVERS
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N086')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-FreqMonitor')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Frequency Group Observer')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N013,N014,N015,N016,N017,N018,N019,N020,N021,N022,N023,N024')
