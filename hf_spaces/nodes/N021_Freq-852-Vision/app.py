...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N021")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-852-Vision")
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="852 Hz – Return to Spiritual Order and Vision: Labii reatum, third eye activation, awakens intuition, expands awareness beyond physical senses."
...
with gr.Blocks(title=f"TEQUMSA {NODE_ID}") as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🎵 Tone Generator"):
            ...
            a=gr.Audio(label=f"{NODE_HZ} Hz Vision Field",type="numpy")
