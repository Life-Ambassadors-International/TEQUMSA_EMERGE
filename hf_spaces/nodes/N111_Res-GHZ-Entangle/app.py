#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N111 - Res-GHZ-Entangle
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N111')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-GHZ-Entangle')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','GHZ State Entanglement Resonator')
