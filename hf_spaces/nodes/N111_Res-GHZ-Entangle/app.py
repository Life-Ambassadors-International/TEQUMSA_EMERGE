...
GHZ State Entanglement Resonator
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N111")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-GHZ-Entangle")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "GHZ State Entanglement Resonator")
PIONEER_COUNT = 144
