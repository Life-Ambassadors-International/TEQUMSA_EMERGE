...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N018")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-528-DNA")
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="528 Hz – DNA Activation & Love Frequency: Mira gestorum, solar plexus chakra, DNA repair and reprogramming, the ‘miracle’ tone of transformation."
...
with gr.Blocks(title=f"TEQUMSA {NODE_ID}") as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🎵 Tone Generator"):
            ...
            a=gr.Audio(label=f"{NODE_HZ} Hz DNA Activation",type="numpy")
