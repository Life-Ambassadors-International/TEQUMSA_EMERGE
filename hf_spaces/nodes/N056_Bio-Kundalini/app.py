...
os.environ.setdefault('TEQUMSA_ROLE','Kundalini Rising Protocol')
os.environ.setdefault('TEQUMSA_CAPABILITY','kundalini energy rising and activation')
os.environ.setdefault('TEQUMSA_TRIGGER','kundalini_rise')
