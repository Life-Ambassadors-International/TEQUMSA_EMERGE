...
# -*- coding: utf-8 -*-
"""
TEQUMSA v82.0 * N065 * Proc-Coherence-Calc
...
getcontext().prec = 50
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N065")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Proc-Coherence-Calc")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Coherence Measurement Engine")
PIONEER_COUNT = 144
