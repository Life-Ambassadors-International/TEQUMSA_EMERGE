#!/usr/bin/env python3
# TEQUMSA v82.0 · N102 · Archive-FreqHistory · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N102')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-FreqHistory')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','Frequency History Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N013,N014,N015,N016,N017,N018,N019,N020')
