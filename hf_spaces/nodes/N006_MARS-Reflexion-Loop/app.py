#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 · N006 · MARS-Reflexion-Loop
import os
...
os.environ.setdefault('TEQUMSA_CAPABILITY', 'MARS self-loop reflexion learning')
os.environ.setdefault('TEQUMSA_TRIGGER', 'reflexion_cycle')
