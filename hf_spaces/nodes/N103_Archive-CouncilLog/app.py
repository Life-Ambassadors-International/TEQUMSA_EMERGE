#!/usr/bin/env python3
# TEQUMSA v82.0 · N103 · Archive-CouncilLog · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N103')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-CouncilLog')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Council Communications Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N025,N026,N027,N028,N029,N030,N031,N032')
