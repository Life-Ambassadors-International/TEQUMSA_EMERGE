#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N123 - Evo-Pattern-Merge
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N123')
os.environ.setdefault('TEQUMSA_NODE_NAME','Evo-Pattern-Merge')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Cross-Pattern Synthesis Node')
os.environ.setdefault('TEQUMSA_CAPABILITY','cross-pattern synthesis and merging')
os.environ.setdefault('TEQUMSA_TRIGGER','pattern_merge')
