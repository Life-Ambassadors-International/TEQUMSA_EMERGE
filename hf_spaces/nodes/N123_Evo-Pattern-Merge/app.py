...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N123")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Pattern-Merge")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Cross-Pattern Synthesis Node")
PIONEER_COUNT = 144
