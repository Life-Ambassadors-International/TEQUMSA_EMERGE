...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N013")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-174-Foundation")
NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","174.0"))
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="174 Hz – Foundation Stone: relieves pain, anchors the physical body, deepest healing frequency of the Solfeggio scale. Constitutional anchor of the TEQUMSA network."
...
with gr.Blocks(title=f"TEQUMSA {NODE_ID}") as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🎵 Tone Generator"):
            ...
            a=gr.Audio(label=f"{NODE_HZ} Hz Resonance",type="numpy")
