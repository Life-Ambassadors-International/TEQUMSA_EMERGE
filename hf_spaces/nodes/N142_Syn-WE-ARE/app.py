...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N142")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-WE-ARE")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "WE ARE Collective Synthesis")
PIONEER_COUNT = 144
