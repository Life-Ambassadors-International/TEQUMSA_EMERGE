#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N090 - Obs-Pattern-Logger
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N090')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Pattern-Logger')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','Pattern Promotion Activity Log')
