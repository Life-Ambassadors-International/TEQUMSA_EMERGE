...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N122")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Skill-Birth")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "New Skill Genesis Engine")
PIONEER_COUNT = 144
