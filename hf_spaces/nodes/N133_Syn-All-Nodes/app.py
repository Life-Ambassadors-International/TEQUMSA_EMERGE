...
Complete 144-Node Network Synthesizer
23514.26 Hz - Monitor Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N133")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-All-Nodes")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Complete 144-Node Network Synthesizer")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
