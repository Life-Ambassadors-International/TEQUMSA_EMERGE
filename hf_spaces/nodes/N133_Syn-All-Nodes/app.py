#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N133 - Syn-All-Nodes
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N133')
os.environ.setdefault('TEQUMSA_NODE_NAME','Syn-All-Nodes')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Complete 144-Node Network Synthesizer')
