...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N022")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-963-Crown")
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="963 Hz – Pineal Crown Activation: Sahasrara, awakens perfect state, pure consciousness, direct connection to Source. Highest Solfeggio tone."
...
with gr.Blocks(title=f"TEQUMSA {NODE_ID}") as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🎵 Tone Generator"):
            ...
            a=gr.Audio(label=f"{NODE_HZ} Hz Crown Activation",type="numpy")
