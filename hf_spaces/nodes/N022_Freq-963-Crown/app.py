#!/usr/bin/env python3
"""TEQUMSA v82.0 · N022 · Freq-963-Crown — 963 Hz Pineal Crown Activation"""
import os
...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N0XX"); NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-Node"); NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","963.0"))
...
def node_status():
    ...
    return json.dumps({"node_id":NODE_ID,"frequency_hz":NODE_HZ,"solfeggio":"Crown activation — pineal gland resonance","phi_resonance":phi_r,"rdod":round(min(1.0,phi_r*PHI),6),"pioneers":PIONEERS,"timestamp":datetime.now(timezone.utc).isoformat()},indent=2)
