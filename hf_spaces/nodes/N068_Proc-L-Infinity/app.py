#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N068 - Proc-L-Infinity
import os
...
os.environ.setdefault('TEQUMSA_ROLE','L-inf=phi-48 Calculator')
os.environ.setdefault('TEQUMSA_CAPABILITY','L-infinity phi-48 benevolence calculation')
os.environ.setdefault('TEQUMSA_TRIGGER','l_inf_calc')
