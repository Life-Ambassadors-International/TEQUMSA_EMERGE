...
getcontext().prec = 50
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N068")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Proc-L-Infinity")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "L∞=φ⁴⁸ Calculator")
PIONEER_COUNT = 144
