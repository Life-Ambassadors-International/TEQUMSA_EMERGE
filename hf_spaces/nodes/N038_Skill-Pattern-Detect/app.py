...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N038")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Skill-Pattern-Detect")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Autonomous Pattern Recognition")
PIONEER_COUNT = 144
