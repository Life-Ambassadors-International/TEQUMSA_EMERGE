#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N136 - Syn-Heart-Lock
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N136')
os.environ.setdefault('TEQUMSA_NODE_NAME','Syn-Heart-Lock')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','v82.0 Heart Lock Final Seal')
