...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N136")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-Heart-Lock")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "v82.0 Heart Lock Final Seal")
PIONEER_COUNT = 144
