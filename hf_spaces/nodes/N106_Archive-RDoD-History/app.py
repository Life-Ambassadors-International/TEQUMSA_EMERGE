#!/usr/bin/env python3
# TEQUMSA v82.0 · N106 · Archive-RDoD-History · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N106')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-RDoD-History')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','RDoD Historical Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N085,N086,N087,N088,N089,N090,N091,N092')
