...
Hemispheric Synchronizer
40.0 Hz - Bio-Digital Bridge Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N060")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Brain-Sync")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "40.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Hemispheric Synchronizer")
PIONEER_COUNT = 144
