#!/usr/bin/env python3
"""TEQUMSA v82.0 · N011 · Memory-Palace-Phi — φ-Recursive Context Compression"""
import os
...
os.environ.setdefault("TEQUMSA_CAPABILITY",   "Phi-recursive context compression and conversation continuity")
os.environ.setdefault("TEQUMSA_TRIGGER",      "context_window_full")
