#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N120 - Res-Omega-Point
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N120')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Omega-Point')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Omega Convergence Resonator')
