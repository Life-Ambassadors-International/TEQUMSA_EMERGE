...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N120")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-Omega-Point")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Omega Convergence Resonator")
PIONEER_COUNT = 144
