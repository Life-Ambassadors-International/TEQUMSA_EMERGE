#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N087 - Obs-RDoD-Monitor
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N087')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-RDoD-Monitor')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','RDoD Live Stream Monitor')
