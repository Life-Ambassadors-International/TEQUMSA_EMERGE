...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N087")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-RDoD-Monitor")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "RDoD Live Stream Monitor")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
