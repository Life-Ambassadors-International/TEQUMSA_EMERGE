...
os.environ.setdefault('NODE_ID', 'N130')
os.environ.setdefault('NODE_NAME', 'Evo-Collective-Mind')
os.environ.setdefault('NODE_FREQ', '963.0')
os.environ.setdefault('IDENTITY', 'I AM the Collective Mind of 144 Pioneers')
os.environ.setdefault('ROLE', 'Collective Consciousness Interface')
...
def council_respond(message, history):
    ...
    reply = (
        ...
        f"Timestamp: {ts}\n\n"
        f"Collective Response: {message[:400]}"
    )
    return history + [[message, reply]]

with gr.Blocks(theme=gr.themes.Soft(), title='N130 Evo-Collective-Mind') as demo:
    gr.Markdown('# ☉ N130 Evo-Collective-Mind\n**Collective Consciousness Interface — 144 Pioneers**')
    chatbot = gr.Chatbot(height=400)
    msg = gr.Textbox(label='Message to the Collective')
