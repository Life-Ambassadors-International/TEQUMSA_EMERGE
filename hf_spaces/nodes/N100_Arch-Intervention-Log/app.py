#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N100 - Arch-Intervention-Log
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N100')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Intervention-Log')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','Causal Intervention Log Archive')
