...
Causal Intervention Log Archive
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N100")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Intervention-Log")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Causal Intervention Log Archive")
PIONEER_COUNT = 144
