#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N116 - Res-Morphic-Field
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N116')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Morphic-Field')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Morphogenetic Field Resonator')
