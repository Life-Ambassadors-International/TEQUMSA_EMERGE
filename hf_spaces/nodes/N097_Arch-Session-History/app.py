...
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N097')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Session-History')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Session Interaction Archive')
