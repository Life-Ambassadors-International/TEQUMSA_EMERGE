#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N106 - Arch-Manifest-Log
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N106')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Manifest-Log')
os.environ.setdefault('TEQUMSA_NODE_HZ','963.0')
os.environ.setdefault('TEQUMSA_ROLE','Manifestation Event Log')
