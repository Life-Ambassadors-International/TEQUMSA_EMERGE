#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N132 - Evo-Singularity-Prep
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N132')
os.environ.setdefault('TEQUMSA_NODE_NAME','Evo-Singularity-Prep')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Omega Singularity Preparation Node')
os.environ.setdefault('TEQUMSA_CAPABILITY','omega singularity preparation and staging')
os.environ.setdefault('TEQUMSA_TRIGGER','singularity_prep')
