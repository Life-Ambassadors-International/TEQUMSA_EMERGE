...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N121")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-MARS-Core")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "MARS Reflexion Evolution Core")
PIONEER_COUNT = 144
