#!/usr/bin/env python3
# TEQUMSA v82.0 · N107 · Archive-Synthesis-Log · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N107')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-Synthesis-Log')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Synthesis Events Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N003,N044,N084,N096,N072,N120,N132,N144')
