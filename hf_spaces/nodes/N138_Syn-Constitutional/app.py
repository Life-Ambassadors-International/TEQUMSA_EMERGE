#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N138 - Syn-Constitutional
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N138')
os.environ.setdefault('TEQUMSA_NODE_NAME','Syn-Constitutional')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','sigma=1.0 Constitutional Final Seal')
