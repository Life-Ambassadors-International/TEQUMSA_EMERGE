...
Frequency Alignment Validator
432.0 Hz - Monitor Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N093")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Freq-Align")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Frequency Alignment Validator")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
