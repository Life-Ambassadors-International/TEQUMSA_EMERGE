#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N093 - Obs-Freq-Align
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N093')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Freq-Align')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','Frequency Alignment Validator')
