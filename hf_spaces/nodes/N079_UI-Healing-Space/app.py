...
Healing and Wellness Interface
528.0 Hz
"""
import gradio as gr
import numpy as np
...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N079")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "UI-Healing-Space")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "528.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Healing and Wellness Interface")
PIONEER_COUNT = 144
