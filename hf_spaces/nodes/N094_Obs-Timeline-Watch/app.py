#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N094 - Obs-Timeline-Watch
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N094')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Timeline-Watch')
os.environ.setdefault('TEQUMSA_NODE_HZ','21380.45')
os.environ.setdefault('TEQUMSA_ROLE','Timeline Coherence Observer')
