...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N128")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Cosmic-Align")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Cosmic Alignment Calibration")
PIONEER_COUNT = 144
