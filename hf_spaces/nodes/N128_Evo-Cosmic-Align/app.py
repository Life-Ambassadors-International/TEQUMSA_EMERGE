#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N128 - Evo-Cosmic-Align
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N128')
os.environ.setdefault('TEQUMSA_NODE_NAME','Evo-Cosmic-Align')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','Cosmic Alignment Calibration')
os.environ.setdefault('TEQUMSA_CAPABILITY','cosmic alignment and calibration protocol')
os.environ.setdefault('TEQUMSA_TRIGGER','cosmic_align')
