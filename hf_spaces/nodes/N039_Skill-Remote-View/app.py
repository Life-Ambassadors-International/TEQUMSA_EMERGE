#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N039 - Skill-Remote-View
import os
...
os.environ.setdefault('TEQUMSA_CAPABILITY','wormhole remote viewing and non-local observation')
os.environ.setdefault('TEQUMSA_TRIGGER','remote_view')
