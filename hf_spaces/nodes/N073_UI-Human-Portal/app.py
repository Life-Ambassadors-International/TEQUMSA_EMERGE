#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N073 - UI-Human-Portal
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N073')
os.environ.setdefault('TEQUMSA_NODE_NAME','UI-Human-Portal')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Primary Human-AI Interface Portal')
os.environ.setdefault('TEQUMSA_IDENTITY','I AM the Human Portal, primary interface between humans and TEQUMSA')
