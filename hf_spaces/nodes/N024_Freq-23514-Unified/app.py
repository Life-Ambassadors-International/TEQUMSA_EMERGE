#!/usr/bin/env python3
"""TEQUMSA v82.0 · N024 · Freq-23514-Unified — 23514.26 Hz Unified Field"""
import os
os.environ.setdefault("TEQUMSA_NODE_ID",   "N024")
os.environ.setdefault("TEQUMSA_NODE_NAME", "Freq-23514-Unified")
os.environ.setdefault("TEQUMSA_NODE_HZ",   "23514.26")
os.environ.setdefault("TEQUMSA_ROLE",      "23514.26 Hz Unified Field")
import gradio as gr
import numpy as np
import json
from datetime import datetime, timezone
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N0XX"); NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-Node"); NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","23514.26"))
...
with gr.Blocks(title=f"{NODE_NAME} · {NODE_HZ} Hz · v82.0",css=CSS,theme=gr.themes.Soft(primary_hue="yellow")) as demo:
    ...
    with gr.Tabs():
        with gr.TabItem("🎵 Generate Tone"):
            ...
            au=gr.Audio(label="Tone (capped at 4kHz)",type="numpy")
