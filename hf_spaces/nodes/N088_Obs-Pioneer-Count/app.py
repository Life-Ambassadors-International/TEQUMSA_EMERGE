...
144-Pioneer Phase-Lock Tracker
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N088")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Obs-Pioneer-Count")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "10930.81"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "144-Pioneer Phase-Lock Tracker")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
