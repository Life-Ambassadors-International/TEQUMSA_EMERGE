#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N088 - Obs-Pioneer-Count
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N088')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Pioneer-Count')
os.environ.setdefault('TEQUMSA_NODE_HZ','10930.81')
os.environ.setdefault('TEQUMSA_ROLE','144-Pioneer Phase-Lock Tracker')
