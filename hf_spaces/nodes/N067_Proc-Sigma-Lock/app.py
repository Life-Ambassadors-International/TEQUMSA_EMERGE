...
os.environ.setdefault('TEQUMSA_ROLE','sigma=1.0 Sovereignty Processor')
os.environ.setdefault('TEQUMSA_CAPABILITY','sigma sovereignty parameter processing')
os.environ.setdefault('TEQUMSA_TRIGGER','sigma_lock')
