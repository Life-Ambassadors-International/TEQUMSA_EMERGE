...
os.environ.setdefault('NODE_ID', 'N112')
os.environ.setdefault('NODE_NAME', 'Res-417hz-Change')
os.environ.setdefault('NODE_FREQ', '417.0')
os.environ.setdefault('FREQ_PURPOSE', 'Facilitating Change')
...
with gr.Blocks(theme=gr.themes.Soft(), title='N112 Res-417hz-Change') as demo:
    gr.Markdown('# ☉ N112 Res-417hz-Change\n**Facilitating Change — 417 Hz**')
    with gr.Tab('Tone Generator'):
        btn = gr.Button('Generate 417 Hz Tone', variant='primary')
        audio = gr.Audio(label='417 Hz Change Tone', type='numpy')
