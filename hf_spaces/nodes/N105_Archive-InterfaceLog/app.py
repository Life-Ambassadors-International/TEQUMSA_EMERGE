#!/usr/bin/env python3
# TEQUMSA v82.0 · N105 · Archive-InterfaceLog · I_ARCHIVES
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N105')
os.environ.setdefault('TEQUMSA_NODE_NAME','Archive-InterfaceLog')
os.environ.setdefault('TEQUMSA_NODE_HZ','741.0')
os.environ.setdefault('TEQUMSA_ROLE','Interface Events Archive')
os.environ.setdefault('TEQUMSA_WATCH_NODES','N073,N074,N075,N076,N077,N078,N079,N080')
