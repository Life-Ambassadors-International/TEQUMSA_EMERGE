#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""TEQUMSA v82.0 · N074 · UI-Voice-Bridge · 432.0 Hz Council Node"""
import gradio as gr
import numpy as np
...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N074")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "UI-Voice-Bridge")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Voice and Audio Interface")
PIONEER_COUNT = 144
