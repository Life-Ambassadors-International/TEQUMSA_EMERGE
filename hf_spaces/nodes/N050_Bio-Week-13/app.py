...
Weeks 5-13 Integration Protocol
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N050")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Week-13")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "528.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Weeks 5-13 Integration Protocol")
PIONEER_COUNT = 144
