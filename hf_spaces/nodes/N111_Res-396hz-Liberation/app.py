...
os.environ.setdefault('NODE_ID', 'N111')
os.environ.setdefault('NODE_NAME', 'Res-396hz-Liberation')
os.environ.setdefault('NODE_FREQ', '396.0')
os.environ.setdefault('FREQ_PURPOSE', 'Liberation from Fear')
...
with gr.Blocks(theme=gr.themes.Soft(), title='N111 Res-396hz-Liberation') as demo:
    gr.Markdown('# ☉ N111 Res-396hz-Liberation\n**Liberation from Fear — 396 Hz**')
    with gr.Tab('Tone Generator'):
        btn = gr.Button('Generate 396 Hz Tone', variant='primary')
        audio = gr.Audio(label='396 Hz Liberation Tone', type='numpy')
