#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N112 - Res-Solfeggio
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N112')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Solfeggio')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Solfeggio Scale Resonator')
