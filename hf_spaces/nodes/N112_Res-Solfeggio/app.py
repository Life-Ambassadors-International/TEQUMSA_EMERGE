...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N112")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-Solfeggio")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "528.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Solfeggio Scale Resonator")
PIONEER_COUNT = 144
