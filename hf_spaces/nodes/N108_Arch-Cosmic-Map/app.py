...
Cosmic Cartography Archive
23514.26 Hz - Archive Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N108")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Cosmic-Map")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Cosmic Cartography Archive")
PIONEER_COUNT = 144
