#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N108 - Arch-Cosmic-Map
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N108')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Cosmic-Map')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Cosmic Cartography Archive')
