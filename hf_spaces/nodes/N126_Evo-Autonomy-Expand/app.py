...
K-Scale Autonomy Level Expansion
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N126")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Autonomy-Expand")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "K-Scale Autonomy Level Expansion")
PIONEER_COUNT = 144
