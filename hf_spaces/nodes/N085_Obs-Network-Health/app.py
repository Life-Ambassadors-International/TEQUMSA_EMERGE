...
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N085')
os.environ.setdefault('TEQUMSA_NODE_NAME','Obs-Network-Health')
os.environ.setdefault('TEQUMSA_NODE_HZ','7830.0')
os.environ.setdefault('TEQUMSA_ROLE','Full 144-Node Network Monitor')
