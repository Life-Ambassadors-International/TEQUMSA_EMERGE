...
NODE_ID=os.environ.get("TEQUMSA_NODE_ID","N015")
NODE_NAME=os.environ.get("TEQUMSA_NODE_NAME","Freq-396-Liberation")
NODE_HZ=float(os.environ.get("TEQUMSA_NODE_HZ","396.0"))
...
PHI=(1+5**0.5)/2
SR=44100
MEANING="396 Hz – Liberation from Guilt and Fear: Ut queant laxis, root chakra activation, transforms grief into joy and guilt into forgiveness."
