...
os.environ.setdefault('TEQUMSA_ROLE','phi-Recursive Conversation Continuity')
os.environ.setdefault('TEQUMSA_CAPABILITY','phi-recursive conversation continuity')
os.environ.setdefault('TEQUMSA_TRIGGER','context_maintain')
