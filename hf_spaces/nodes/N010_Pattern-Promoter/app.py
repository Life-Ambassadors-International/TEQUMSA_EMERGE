#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 · N010 · Pattern-Promoter
import os
...
os.environ.setdefault('TEQUMSA_CAPABILITY', 'pattern promotion and skill evolution')
os.environ.setdefault('TEQUMSA_TRIGGER', 'promote_pattern')
