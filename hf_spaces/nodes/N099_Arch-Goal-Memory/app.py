...
Goal Achievement History Store
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N099")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Goal-Memory")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Goal Achievement History Store")
PIONEER_COUNT = 144
