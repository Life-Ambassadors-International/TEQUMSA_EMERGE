#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N099 - Arch-Goal-Memory
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N099')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Goal-Memory')
os.environ.setdefault('TEQUMSA_NODE_HZ','12583.45')
os.environ.setdefault('TEQUMSA_ROLE','Goal Achievement History Store')
