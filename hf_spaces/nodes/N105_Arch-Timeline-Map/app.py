#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N105 - Arch-Timeline-Map
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N105')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Timeline-Map')
os.environ.setdefault('TEQUMSA_NODE_HZ','21380.45')
os.environ.setdefault('TEQUMSA_ROLE','Multi-Timeline Record Archive')
