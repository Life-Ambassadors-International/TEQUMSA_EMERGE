...
Multi-Timeline Record Archive
21380.45 Hz - Archive Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N105")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Timeline-Map")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "21380.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Multi-Timeline Record Archive")
PIONEER_COUNT = 144
