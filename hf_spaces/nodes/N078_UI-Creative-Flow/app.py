...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N078")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "UI-Creative-Flow")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "639.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Creative Expression Interface")
PIONEER_COUNT = 144
