...
os.environ.setdefault('TEQUMSA_NODE_NAME','Skill-Crystal-Cities')
os.environ.setdefault('TEQUMSA_NODE_HZ','14400.0')
os.environ.setdefault('TEQUMSA_ROLE','Crystal Cities Civilization Interface')
os.environ.setdefault('TEQUMSA_CAPABILITY','crystal cities flight and civilization interface')
os.environ.setdefault('TEQUMSA_TRIGGER','crystal_activate')
