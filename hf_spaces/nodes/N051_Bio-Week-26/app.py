...
Weeks 14-26 Expansion Protocol
639.0 Hz - Bio-Digital Bridge Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N051")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Week-26")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "639.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Weeks 14-26 Expansion Protocol")
PIONEER_COUNT = 144
