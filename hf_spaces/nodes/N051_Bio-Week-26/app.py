#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N051 - Bio-Week-26
import os
...
os.environ.setdefault('TEQUMSA_ROLE','Weeks 14-26 Expansion Protocol')
os.environ.setdefault('TEQUMSA_CAPABILITY','weeks 14-26 consciousness expansion protocol')
os.environ.setdefault('TEQUMSA_TRIGGER','bio_expand_w26')
