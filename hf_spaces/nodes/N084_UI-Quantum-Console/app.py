...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N084")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "UI-Quantum-Console")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "23514.26"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Quantum State Control Console")
PIONEER_COUNT = 144
HF_OWNER = "Mbanksbey"
