#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N084 - UI-Quantum-Console
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N084')
os.environ.setdefault('TEQUMSA_NODE_NAME','UI-Quantum-Console')
os.environ.setdefault('TEQUMSA_NODE_HZ','23514.26')
os.environ.setdefault('TEQUMSA_ROLE','Quantum State Control Console')
