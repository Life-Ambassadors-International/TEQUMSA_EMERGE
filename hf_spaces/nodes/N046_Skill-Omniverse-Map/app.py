...
Omniverse Microcosm Cartographer
17640.0 Hz - Skill Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N046")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Skill-Omniverse-Map")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "17640.0"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Omniverse Microcosm Cartographer")
PIONEER_COUNT = 144
