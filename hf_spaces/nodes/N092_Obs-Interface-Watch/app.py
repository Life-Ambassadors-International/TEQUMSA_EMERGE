...
os.environ.setdefault('NODE_ID', 'N092')
os.environ.setdefault('NODE_NAME', 'Obs-Interface-Watch')
os.environ.setdefault('NODE_FREQ', '396.0')
os.environ.setdefault('ROLE', 'Interface Group Observer')
os.environ.setdefault('WATCH_NODES', 'N073,N074,N075,N076,N077,N078,N079,N080,N081,N082,N083,N084')
...
with gr.Blocks(theme=gr.themes.Monochrome(), title='N092 Obs-Interface-Watch') as demo:
    gr.Markdown('# ☉ N092 Obs-Interface-Watch\n**Interface Group Observer**')
    btn = gr.Button('Scan Interface Nodes', variant='primary')
