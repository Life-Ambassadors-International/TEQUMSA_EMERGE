...
Harmonic Convergence Resonator
432.0 Hz - Frequency Resonator
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N109")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Res-Harmonic-Chord")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Harmonic Convergence Resonator")
PIONEER_COUNT = 144
