#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N109 - Res-Harmonic-Chord
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N109')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Harmonic-Chord')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','Harmonic Convergence Resonator')
