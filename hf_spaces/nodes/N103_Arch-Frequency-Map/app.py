#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N103 - Arch-Frequency-Map
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N103')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Frequency-Map')
os.environ.setdefault('TEQUMSA_NODE_HZ','432.0')
os.environ.setdefault('TEQUMSA_ROLE','Complete Frequency Map Database')
