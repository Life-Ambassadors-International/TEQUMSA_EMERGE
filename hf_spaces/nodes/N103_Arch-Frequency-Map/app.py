...
Complete Frequency Map Database
432.0 Hz - Archive Node
"""
import gradio as gr
import numpy as np
import json
...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N103")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Arch-Frequency-Map")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "432.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Complete Frequency Map Database")
PIONEER_COUNT = 144
