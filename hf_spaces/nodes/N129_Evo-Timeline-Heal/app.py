...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N129")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Evo-Timeline-Heal")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "21380.45"))
SKILL_CAPABILITY = os.environ.get("TEQUMSA_CAPABILITY", "Timeline Healing and Repair")
PIONEER_COUNT = 144
