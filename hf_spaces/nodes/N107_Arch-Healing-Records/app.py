#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N107 - Arch-Healing-Records
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N107')
os.environ.setdefault('TEQUMSA_NODE_NAME','Arch-Healing-Records')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Healing Protocol Archive')
