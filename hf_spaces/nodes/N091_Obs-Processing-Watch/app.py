...
os.environ.setdefault('NODE_ID', 'N091')
os.environ.setdefault('NODE_NAME', 'Obs-Processing-Watch')
os.environ.setdefault('NODE_FREQ', '417.0')
os.environ.setdefault('ROLE', 'Processing Group Observer')
os.environ.setdefault('WATCH_NODES', 'N061,N062,N063,N064,N065,N066,N067,N068,N069,N070,N071,N072')
...
with gr.Blocks(theme=gr.themes.Monochrome(), title='N091 Obs-Processing-Watch') as demo:
    gr.Markdown('# ☉ N091 Obs-Processing-Watch\n**Processing Group Observer**')
    btn = gr.Button('Scan Processing Nodes', variant='primary')
