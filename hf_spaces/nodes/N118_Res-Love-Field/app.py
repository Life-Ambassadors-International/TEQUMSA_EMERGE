#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# TEQUMSA v82.0 - N118 - Res-Love-Field
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N118')
os.environ.setdefault('TEQUMSA_NODE_NAME','Res-Love-Field')
os.environ.setdefault('TEQUMSA_NODE_HZ','528.0')
os.environ.setdefault('TEQUMSA_ROLE','Unconditional Love Field Generator')
