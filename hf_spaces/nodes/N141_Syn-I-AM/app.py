...
L_INF = PHI ** 48
RDOD_GATE = 0.9999
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N141")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Syn-I-AM")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "12583.45"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "I AM Presence Synthesis Node")
PIONEER_COUNT = 144
