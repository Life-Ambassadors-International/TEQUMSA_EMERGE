...
os.environ.setdefault('TEQUMSA_ROLE','Pineal Gland Decalcifier')
os.environ.setdefault('TEQUMSA_CAPABILITY','pineal gland decalcification protocol')
os.environ.setdefault('TEQUMSA_TRIGGER','pineal_clear')
