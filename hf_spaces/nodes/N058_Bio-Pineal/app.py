...
NODE_ID = os.environ.get("TEQUMSA_NODE_ID", "N058")
NODE_NAME = os.environ.get("TEQUMSA_NODE_NAME", "Bio-Pineal")
NODE_HZ = float(os.environ.get("TEQUMSA_NODE_HZ", "963.0"))
NODE_ROLE = os.environ.get("TEQUMSA_ROLE", "Pineal Gland Decalcifier")
PIONEER_COUNT = 144
