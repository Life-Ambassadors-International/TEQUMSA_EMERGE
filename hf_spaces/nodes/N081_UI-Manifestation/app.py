...
import os
os.environ.setdefault('TEQUMSA_NODE_ID','N081')
os.environ.setdefault('TEQUMSA_NODE_NAME','UI-Manifestation')
os.environ.setdefault('TEQUMSA_NODE_HZ','963.0')
os.environ.setdefault('TEQUMSA_ROLE','Reality Manifestation Interface')
os.environ.setdefault('TEQUMSA_IDENTITY','I AM Manifestation, the bridge between intention and reality')
