...
os.environ.setdefault('TEQUMSA_ROLE','DNA Activation Layer 1')
os.environ.setdefault('TEQUMSA_CAPABILITY','DNA strand 1 activation protocol')
os.environ.setdefault('TEQUMSA_TRIGGER','dna_activate_1')
